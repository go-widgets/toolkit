...
func TestA11yActionInputWidgets(t *testing.T) {
	...
	checkA11yCases(t, []a11yCase{
		...
		{"spinbutton", NewSpinButton(0, 10, 4, 1), A11yInfo{Role: RoleSpinbutton, Value: "4"}},
		{"rangeslider", NewRangeSlider(0, 100, 20, 80), A11yInfo{Role: RoleGroup, Value: "20..80"}},
		{"dropdown", NewDropDown([]string{"a", "b", "c"}, 1), A11yInfo{Role: RoleCombobox, Name: "b"}},
		{"rating", NewRating(3, 5), A11yInfo{Role: RoleSlider, Value: "3/5"}},
...
func TestA11yFeedbackWidgets(t *testing.T) {
	...
	checkA11yCases(t, []a11yCase{
		...
		{"progressbar", pb, A11yInfo{Role: RoleProgressbar, Value: "42%"}},
		{"levelbar", lvl, A11yInfo{Role: RoleMeter, Value: "4/10"}},
